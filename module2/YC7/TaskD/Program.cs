...
public class Program
{
    ...
    public static void Main(string[] args)
    {
        ...
        {
            Console.WriteLine(brigantine.IsAtThePort ? $"Brigantine. {brigantine.CountCost(weight)}$" : "Could not deliver cargo.");
        }
        else
        {
            Console.WriteLine(!boat.IsAtThePort ? $"Brigantine. {((Boat)brigantine).CountCost(weight)}$" : $"Boat. {boat.CountCost(weight)}$");
        }
    }
}